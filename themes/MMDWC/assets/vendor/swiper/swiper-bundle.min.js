...
var Swiper = (function () {
  ...
  function V(e) {
    ...
    if ('number' == typeof d.custom - button && d.custom - button > 0) return;
  ...
  const ye = [
      ...
      function n(t, s) {
        ...
        w(t).forEach((t) => {
          t &&
            ...
            'custom-button' === t.tagName && (t.disabled = s),
    ...
    ({ swiper: e, extendParams: t, on: s }) => {
      ...
      const x = (e, t, s) => {
          (d(e),
            'custom-button' !== e.tagName &&
              (u(e, 'custom-button'), e.addEventListener('keydown', b)),
            f(e, s));
        },
        T = (t) => {
